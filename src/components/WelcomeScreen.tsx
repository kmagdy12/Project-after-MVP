  ...
  const tutorialSteps = [
    {
      ...
      icon: Building2,
      content: "VentureHub connects founders, investors, and mentors across the Middle East and North Africa region. Our AI-powered platform helps you discover opportunities, build relationships, and scale your venture.",
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">
            {profileCompleted ? "Welcome back!" : "Welcome to VentureHub!"}
          </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-linkedin-card/50 backdrop-blur-sm rounded-xl border border-linkedin-border overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-400 text-sm">Experience the power of {tutorialSteps[currentStep].title.toLowerCase()} on VentureHub</p>
                  </div>
                </div>
