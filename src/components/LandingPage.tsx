      ...
      <header className="relative z-50 px-6 py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-white">VentureHub</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the tools and features that make VentureHub the leading platform for MENA's startup ecosystem
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-linkedin-card backdrop-blur-lg rounded-2xl p-8 border border-linkedin-border">
              ...
              <p className="text-gray-300 mb-6">"VentureHub connected us with the perfect investor who understood our vision and the MENA market dynamics."</p>
