    ...
    <div className="bg-linkedin-card backdrop-blur-lg rounded-xl border border-linkedin-border p-6">
      ...
      <div className="space-y-5">
        {suggestions.map((person) => (
          <div key={person.id} className="flex items-center space-x-4 p-4 rounded-lg hover:bg-linkedin-card/70 transition-colors">
            <img 
            ...
            <button className="flex items-center space-x-2 bg-linkedin hover:bg-linkedin-dark text-white px-4 py-1.5 rounded-full text-sm font-semibold transition-colors border border-linkedin">
